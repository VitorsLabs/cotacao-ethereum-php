...
//braziliex
$jsonbraziliex = file_get_contents("https://braziliex.com/api/v1/public/ticker/eth_brl"); //puxa os dados da api
...
//bitcointrade
$json_bitcointrade = file_get_contents("https://api.bitcointrade.com.br/v2/public/BRLETH/ticker");
...
//mercadobitcoin
$json_mercadobitcoin = file_get_contents("https://www.mercadobitcoin.net/api/eth/ticker/");
...
//flowbtc
$json_flowbtc = file_get_contents("https://publicapi.flowbtc.com.br/v1/ticker/ethbrl");
...
//tembtc
$json_tembtc = file_get_contents("https://broker.tembtc.com.br/api/v3/ethbrl/ticker");
